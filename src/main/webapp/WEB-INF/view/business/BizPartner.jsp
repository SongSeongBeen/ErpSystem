	            	...
	            	<li class="contents">
	               		...
	               		<div class="content">
		                	<p class="Location">
		                     	...
		                     	<span class="btn_nav bold"> 거래처관리 </span> 
		                     	<a href=javascript:location.reload(); class="btn_set refresh">새로고침</a>
	                  		</p>
	                  		<p class="conTitle">
	                     		<span>거래처관리</span> 
	                     		<span class="fr"> 
		                     		<a class="btnType blue" href="javascript:BizPartnerModal1();" name="modal">
		                     			<span>거래처등록</span>
		                     		</a>
	                     		</span>
	                  		</p>
					        ...
					        <!--  == 콤보박스로 체크  -->
			     			...
			     			<!--검색   -->
							<br>       
							<div style = "padding : 3% 3% 3% 3%  ; border : 3px #CDECFA; border-style : solid ; margin: auto;">
