...
<script type="text/javascript">
	...
	// 그룹코드 페이징 설정
	var pageSizeComnGrpCod = 5;  //조회했을때 결과 목록의 갯수 5개씩 묶여 출력. 6부터는 2페이지
	var pageBlockSizeComnGrpCod = 5; //네이게이션바에 출력되는 페이지 개수 6부터는 다음을 눌러야 보임
					...
					<div class="content">
						...
						<p class="Location">
							<a href="../dashboard/dashboard.do" class="btn_set home">메인으로</a> <span
								class="btn_nav bold">시스템 관리</span> <span class="btn_nav bold">공통코드
								관리</span> 
						</p>

					<p class="conTitle">
							<span><a href="../system/comnCodMgr.do">그룹 코드</a></span> <span class="fr"> <a
