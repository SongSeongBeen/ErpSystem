			...
			<ul>
				...
				<li class="contents">
					...
					<div class="content">
						...
						<p class="Location">
							<a href="#" class="btn_set home">메인으로</a> <a href="#" class="btn_nav">회계</a> <span class="btn_nav bold">
			...
			<!-- 지출결의서 조회 조건 -->
						...
						<div class = "selectEmpDv">
							<ul>
							 ...
							 <a class="btnType blue" href="javascript:fListBmDv()" id="searchEnter" name="search">
									  <span>조회</span></a>
					</div>
