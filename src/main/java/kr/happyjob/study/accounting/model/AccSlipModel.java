...
public class AccSlipModel {
	...
	private String receive_no; 	/* 수주번호 */
	private Date receive_date; /* 수주일자 */
	private String occur_date;
	private int en_amt; /* 수입 */
	private String rp_nm; 	/* 담당자 */
	private String note; /* 비고 */
	private String client_cd; /* 고객사 코드 */
