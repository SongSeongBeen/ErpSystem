...
<!-- 모달팝업 ==  신규 등록 1 -->
<div id="receiveModal" class="layerPop layerType2"  style="width: 1200px; overflow-y: scroll;">
	<dl>
		<dt>
		...
		<dd class="content">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<select name="clientSearch1" id ='clientSearch1' onchange="receiveSearchClient()"></select>
						</td>
						<td hidden="">
							<select name="estimateNoSearch" id ='estimateNoSearch'></select>
						</td>
			...
			<div class="btn_areaC mt30">
				<a href="" class="btnType blue" id="btnReceiveInfoInsert" name="btn"><span>등록</span></a>
