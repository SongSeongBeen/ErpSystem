...
// 	}
	...
	function leadingZeros(n, digits) { // 월과 일이 한자리수일 때 앞에 0붙여주는 함수 
				...
				<ul>
					...
					<li class="contents">
						...
						<div class="content">
							...
							<!-- 근태신청 데이터 리스트 조회  -->
<!-- 							<p><span>근태신청/조회</span> <span class="fr" style="margin-top:3.5px;">  </p> -->
							...
							<div class="divempTaApplyList">
								...
								<p class="conTitle">
									<span> </span> <span class="fr" style="margin-top:3.5px;"> 
									<span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<Strong>일자 </Strong> 
									<input type="date" id="from_date">&nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;<input type="date" id="to_date"><br>
									<Strong>근태종류</Strong>
									<select id="lev_type" style="width: 98px;">
									...
									&nbsp;<Strong>결재상태</Strong>
									<select id="ta_yn" style="width: 100px;">
											<option value="">전체</option>
											<option value="2">승인</option>
											<option value="3">반려</option>
											<option value="1">승인대기</option> 
									</select>
									&nbsp;<a class="btnType blue" href="javascript:fEmpTaApplyList()" name="search" style="margin: 3px -24px 3px 0px;" > 
