               ...
               <div class="content">
                  ...
                  <p class="Location">
                     <a href="#" class="btn_set home">메인으로</a> <a href="#"
                        class="btn_nav">인사 관리</a> <span class="btn_nav bold">근태 관리</span> <a href="#" class="btn_set refresh">새로고침</a>
                  </p>
                  ...
                  <p class="conTitle">
									...
									<span id="text3" style="margin:0px 0px 3px 3px;"> <strong> 승인여부 </strong>
									<select id="ta_yn" name="ta_yn" class="boxx" style="margin:0px 30px 0px 10px; width:80px;"> 
									...
									<span class="fr" style="margin-top:3.5px;"> 	
									<span> <Strong>등록일자 </Strong> 
									<input type="date" id="from_date" style="margin:0px 0px 3px 0px;">&nbsp;&nbsp;~&nbsp;&nbsp;<input type="date" id="to_date" style="margin:0px 0px 3px -20px;"><br>
									
									
									<Strong>사번</Strong>
									<input type="text" style="width:98px" id="loginID" name="loginID">
									&nbsp;<Strong>사원명</Strong>
									<input type="text" style="width:98px" id="name" name="name">
									&nbsp;<a class="btnType blue"  style="margin: 3px -24px 3px 0px;" href="javascript:fAappList()"><span id="searchEnter">검색</span></a>
									</span>
									</span>							
