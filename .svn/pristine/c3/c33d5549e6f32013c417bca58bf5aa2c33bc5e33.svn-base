...
<c:if test="${receiveDetailCnt eq 0}">
	<tr>
...
<!-- 단건조회시 카운트와 연관 깊음 -->
<input type="hidden" id="receiveDetailCnt" name="receiveDetailCnt" value="${receiveDetailCnt}" />
