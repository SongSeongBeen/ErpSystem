...
<script type="text/javascript">
	...
	function showEmpList(currentPage, retire_yn, abs_yn){ //변경
		...
		if (retire_yn == 'y'){
			...
			$('#showAbsEmp').removeClass('color2');
			$('#showAbsEmp').addClass('color1');
			...
			//재직자/퇴직자 버튼 색깔 변경 /// 재직자 버튼
			$('#showInEmp').removeClass('color1'); //재직자
			...
			if(abs_yn == 'y'){
				//휴직자 구분. 휴직일자 구하기 /// 휴직자 버튼
				$('#showInEmp').removeClass('color2'); //휴직자
				$('#showInEmp').addClass('color1');
				
				$('#showOutEmp').removeClass('color2');
				$('#showOutEmp').addClass('color1');
				
				$('#showAbsEmp').removeClass('color1');
				$('#showAbsEmp').addClass('color2');
...
// 		)
	...
	function showEmpListResult(data, currentPage){
		...
		var abs_yn = $('#absEmpStatus').val(); //추가   
		
		//alert("retire :" + retire_yn + "  abs :" + abs_yn); //넘기는 값 확인	
		//alert("current : " + currentPage + "  total : " + empTotalCnt); //페이지값 확인
		
		var paginationHtml = getPaginationHtml(currentPage, empTotalCnt, pageSizeEmpList, pageBlockSizeEmpList, 'showEmpList',[retire_yn] ,[abs_yn]);
...
<body>
	<form id="myForm" action="" method="">
		...
		<input type="hidden" id="absEmpStatus" value="">
					...
					<li class="contents">
						...
						<div class="content">
							...
							<p class="Location">
								...
								<span class="btn_nav bold">인사 관리</span> <a href="/employee/empMgt.do" class="btn_set refresh">새로고침</a>
							</p>
							...
							<table
								...
								<tr style="border: 0px; border-color: blue">
									<td width="7%" height="25"
										style="font-size: 120%; text-align: center;">부서</td>
									<td width="9%" height="25"
										style="font-size: 100%; text-align: left;"><select
										id="searchKey_dept" name="searchKey_dept" style="width: 70px;"></select>
									</td>
									<td width="7%" height="25"
										style="font-size: 120%; text-align: center;">직급</td>
									<td width="10%" height="25"
										style="font-size: 100%; text-align: left;"><select
										id="searchKey_poscd" name="searchKey_poscd"
									...
									<td width="*" height="25" align="right"
										...
										href="javascript:showEmpList()" class="btnType3 color2"
										id="btnSearchEmpMgt" name="btn"><span>검 색</span></a></td>
								</tr>
							</table>

							<span class="fl"> 
								<a id="showInEmp" class="btnType3 color2" href="javascript:showEmpList(1, 'n','n')"><span>재직자</span></a>
								<a id="showOutEmp" class="btnType3 color1" href="javascript:showEmpList(1, 'y','n')"><span>퇴직자</span></a>
								<a id="showAbsEmp" class="btnType3 color1" href="javascript:showEmpList(1, 'n','y')"><span>휴직자</span></a>
							</span> 
							<span class="fr">
								<p class="Location">
								...
								<table class="col">
									...
									<thead>
										<tr>
											...
											<th scope="col" id="AbsenceDay">휴직일자</th>
										</tr>
									</thead>
						...
						<tbody>
							<tr>
								<td rowspan="3" id="userProfile" class="userProfile profile">
									<span id="profilePreview"> </span> <input type="file"
							...
							<tr>
								...
								<td><input type="text" class="inputTxt p100" name="regno"
									id="regno" placeholder="000000-0000000" /></td>
								<th scope="row">성별<span class="font_red">*</span></th>
								<td><input type="radio" id="sex-1" name="sex" value='1' />
									<label for="sex-1">남</label> &nbsp;&nbsp;&nbsp;&nbsp; <input
									type="radio" id="sex-2" name="sex" value="2" /> <label
									for="sex-2">여</label></td>
							</tr>

							<tr>
								<th scope="row">생년월일</th>
								<td><input type="text" class="inputTxt p100"
									name="birthday" id="birthday" placeholder="0000.00.00" /></td>
					...
					<table class="row" style="margin-top: 0.5%;">
						...
						<tbody>
							<tr>
								...
								<td><input class="inputTxt" style="width: 40%" type="text"
									id="mail1" name="mail1"> @ <input class="inputTxt"
									style="width: 45%" type="email" id="mail2" name="mail2"
									list="defaultEmails" placeholder="직접입력"> <datalist
										id="defaultEmails">
								...
								</select> - <input class="inputTxt" style="width: 28%" maxlength="4"
									type="text" id="tel2" name="tel2"> - <input
									class="inputTxt" style="width: 28%" maxlength="4" type="text"
									id="tel3" name="tel3"></td>
							</tr>
							<tr>
								<th scope="row" rowspan="3">주소<span class="font_red">*</span></th>
								<td><input type="text" class="inputTxt" style="width: 50%;"
									name="zip_code" id="zip_code" readonly /> <input type="button"
									value="우편번호 찾기" onclick="execDaumPostcode()" id="post_cd"
									style="width: 35%; height: 100%; cursor: pointer;" /></td>
								<th scope="row">은행계좌<span class="font_red">*</span></th>
								<td><select id="bank" name="bank" style="width: 33%;"></select>
									<input class="inputTxt" style="width: 63%" type="text"
									id="account" name="account"></td>
							</tr>
							<tr>
								<td><input type="text" class="inputTxt" style="width: 90%"
									name="addr" id="addr" readonly /></td>
							</tr>
							<tr>
								<td><input type="text" class="inputTxt p100"
					...
					<table class="row" style="margin-top: 0.5%;">
						...
						<tbody>
							<tr>
								...
								<td><select id="dept_cd" name="dept_cd" style="width: 65%;"></select>
								</td>
								<th scope="row">직무<span class="font_red">*</span></th>
								<td><select id="user_type" name="user_type"
									style="width: 83%;"></select></td>
								<th scope="row">직급<span class="font_red">*</span></th>
								<td><select id="poscd" name="poscd" style="width: 65%;"></select>
								</td>
							</tr>
							<tr>
								<th scope="row">입사일<span class="font_red">*</span></th>
								<td><input type="date" id="entry_date" name="entry_date"
									style="width: 90%; height: 80%"></td>
								<th scope="row">재직구분<span class="font_red">*</span></th>
								<td><input type="radio" name="rest_yn" id="rest_yn"
									value='n' /> <label for="rest_n" style="margin-right: 2%;">재직</label>
									<input type="radio" name="rest_yn" id="rest_yn" value="y" /> <label
									for="rest_y" style="margin-right: 2%;">휴직</label> <input
									type="radio" name="out_yn" id="out_yn" value='out_y' disabled />
									<label for="out_n">퇴직</label></td>
								<th scope="row">퇴사일</th>
								<td><input type="date" id="retire_date" name="retire_date"
									style="width: 90%; height: 80%" readonly></td>
							</tr>
							<tr>
								<th scope="row">근무연차</th>
								<td><input type="text" class="inputTxt p100"
									name="workyear" id="workyear" style="text-align: right;"
									readonly /></td>
								<th scope="row">연봉<span class="font_red">*</span></th>
								<td><input type="text" class="inputTxt" style="width: 67%"
...
<!-- 										style="resize: none;"></textarea></td> -->
							...
							<tr>
								<th scope="row">퇴직금</th>
								<td><input type="text" class="inputTxt p100" name="oamt"
									id="oamt" style="text-align: right;" readonly /></td>
					...
					<div class="btn_areaC mt30">
						<a href="javascript:empRegister()" class="btnType blue"
							id="btnEmpRegister" name="btn"><span>저장</span></a>
						<!-- 혹시 잘못 저장했을 경우를 위한 삭제 -->
						<a href="javascript:deleteEmp()" class="btnType blue"
							id="btnDeleteEmp" name="btn"><span>삭제</span></a> <a href=""
							class="btnType gray" id="btnCloseEmp" name="btn"><span>취소</span></a>
					</div>
				</dd>
			</dl>
...
<!-- style="text-align: left;"text-align:center;" -->
						...
						<tr>
							<td colspan="4"><textarea id="write_retire_note"
									name="write_retire_note" style="resize: none;"></textarea></td>
						</tr>
					</tbody>
				</table>
